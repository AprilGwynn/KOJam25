...
public class SelectionHistoryWindow : EditorWindow
{
    ...
    public static bool RememberOrder
    {
        get { return EditorPrefs.GetBool(PlayerSettings.productName + "_SH_RememberOrder", true); }
        set { EditorPrefs.SetBool(PlayerSettings.productName + "_SH_RememberOrder", value); }
    }
    ...
    private void AddToHistory()
    {
        ...
        else if (RememberOrder){
			selectionHistory.Remove(Selection.activeObject);
    ...
    private void OnGUI()
    {
        ...
        if (EditorGUILayout.BeginFadeGroup(settingAnimation.faded))
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                EditorGUILayout.LabelField("Update Order", EditorStyles.boldLabel,GUILayout.Width(100f));
                RememberOrder = EditorGUILayout.ToggleLeft("(Incompatible with [] buttons)", RememberOrder, GUILayout.MaxWidth(200f));
            }
